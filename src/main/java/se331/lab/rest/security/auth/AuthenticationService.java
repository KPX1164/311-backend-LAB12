...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    Organiser organiser = Organiser.builder().name(request.getUsername() + " Organisation").build();
    ...
    organiser.setUser(savedUser);
    organiserRepository.save(organiser);
    var jwtToken = jwtService.generateToken(user);
    var refreshToken = jwtService.generateRefreshToken(user);
    saveUserToken(savedUser, jwtToken);
    return AuthenticationResponse.builder()
            .user(LabMapper.INSTANCE.getOrganiserAuthDTO(organiser))
...
//    revokeAllUserTokens(user);
    ...
    return AuthenticationResponse.builder()
            .accessToken(jwtToken)
            .refreshToken(refreshToken)
            .user(LabMapper.INSTANCE.getOrganiserAuthDTO(user.getOrganiser()))
            .build();
  }
